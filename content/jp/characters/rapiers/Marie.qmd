...
素早い突きと間合いを詰める突進攻撃が強力であるが, 斬撃は動きが遅く弱々しいので乱用しないようにしたい. 通常攻撃の `r replace_keys("[T] [H]")` が突き攻撃に, `r replace_keys("[Y] [G]")` が振り攻撃になっている. 突き攻撃は予備動作が少なく気づかれにくいが, 振り攻撃はわかりやすく, その上攻撃力があまり高くない.
