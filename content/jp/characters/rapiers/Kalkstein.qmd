...
自動防御は隙が少なく弾かれにくいので, 積極的に使うと良い. ただし, 足元の守りにいくらか隙がある. そして攻撃も移動も遅いので, 間合いは依然として重要である. 前後ステップは距離が長い, というか走るのに近い動作なので, うまく使うと良い. [ゲデオン](../sabers/Gedeon.qmd#sec-Gedeon) のように足が切り替わることを利用し, 斜め移動で距離を稼ぐのも良いだろう.
